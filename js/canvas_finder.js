/**
 * Source : https://training.iiif.io/
 * Code : https://training.iiif.io/advanced_iiif/day-two/image-servers/images_in_manifest.html
**/
        ...
        for (const sequence of sequences) {
            if ('canvases' in sequence) {
                ...
                for (const canvas of sequence.canvases) {
                    ...
                    var iiifURL = canvas.images[0].resource.service["@id"]+"/info.json";
